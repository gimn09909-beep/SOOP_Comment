...
{change.likesDiff < 0 && <span className="text-[10px] font-black text-red-500 dark:text-red-400 animate-pulse tabular-nums">{change.likesDiff}</span>}
        ...
        <div className="flex items-center gap-1.5 sm:hidden justify-end mb-1.5">
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 spring-transition">
