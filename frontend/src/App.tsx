  ...
  return (
    <div style={{ animationDelay: `${delay}ms` }} className={rowClasses}>
      ...
      <div className="flex items-center gap-2 sm:hidden">
        ...
        <div className="flex items-center gap-1 flex-shrink-0 mt-0.5 self-start">
          ...
          <button aria-label="링크 복사" onClick={copyLink} className={`${btnBase} bg-white dark:bg-gray-800 text-gray-400 dark:text-gray-500 hover:text-brand border border-gray-100 dark:border-gray-700`} title="링크 복사"><LinkIcon className="w-3 h-3" /></button>
